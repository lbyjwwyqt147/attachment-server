...
public class ResultUtil {
     ...
     * @return
     */
    public static RestfulVo resultInfo(Integer status,String message,Object data){
        RestfulVo result = RestfulVo.getInstance();
     ...
     * @return
     */
    public static RestfulVo error(Integer code,String message){
        RestfulVo result = RestfulVo.getInstance();
